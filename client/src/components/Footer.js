      ...
      <div className='h-[103px] w-full bg-main flex justify-center items-center'>
        <div className='w-main flex justify-between items-center'>
          ...
          <div className='flex-1 flex items-center'>
            <input
              className='p-4 pr-0 rounded-l-full w-full bg-[#F04646] outline-none text-gray-100 placeholder:text-gray-100 placeholder:text-sm placeholder:italic placeholder:opacity-50'
              type='text'
